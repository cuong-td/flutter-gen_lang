...
class $en extends MessageLookupByLibrary {
  ...
  final Map<String, dynamic> messages = {
		...
		"messageWithParams" : (dynamic yourName) => "Hi ${yourName}, Welcome you!",
...
class $ja extends MessageLookupByLibrary {
  ...
  final Map<String, dynamic> messages = {
		...
		"messageWithParams" : (dynamic yourName) => "こんにちは${yourName}、ようこそ。",
...
class $zh_TW extends MessageLookupByLibrary {
  ...
  final Map<String, dynamic> messages = {
		...
		"messageWithParams" : (dynamic yourName) => "你好 ${yourName}，歡迎你。",
...
Map<String, LibraryLoader> _deferredLibraries = {
	...
	"zh_TW": () => Future<LibraryLoader>.value(null),
