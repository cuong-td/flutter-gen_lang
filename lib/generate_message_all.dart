...
String generateMessageFunction(Arguments args, String message) {
  return '''(${args.toTypedList()}) => "${normalizedJsonMessage(message)}"''';
}
...
String generateDeferredLibrariesLibrary(String locale) {
  return '''\t"$locale": () => Future<LibraryLoader>.value(null),''';
}
