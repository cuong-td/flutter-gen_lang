...
class I18nOption {
  ...
  @override
  String toString() {
    return 'I18nOption{sourceDir: $sourceDir, templateLocale: $templateLocale, outputDir: $outputDir, className: $className}';
  }
}
...
void _handleGenerateI18nDart(
  ...
  StringBuffer gettersMapBuilder = StringBuffer();
      ...
      case MessageType.message:
        {
          if (hasArgsInMessage(message.message)) {
            ...
            gettersMapBuilder
                .write('''\t\t'$jsonKey' : ${toCamelCase(jsonKey)},\n''');
